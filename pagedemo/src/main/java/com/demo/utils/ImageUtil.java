...
public class ImageUtil {
	...
	/**
	 * 将oldfile的图片文件等比例压缩为size的newfile文件
	 */
	...
	public static boolean compressPic(String inputFile, String outFile, int width, int height, boolean proportion) {
		try {
			...
			if (img.getWidth(null) == -1) {
				...
				/*
				 * if (img.getWidth(null) < width && img.getHeight(null) < height) { newWidth =
				 * img.getWidth(null); newHeight = img.getHeight(null); }
				 */
