...
<body>
	<form action='http://192.168.20.3:8084/dzxz-youzan-webapp/bdp/product/addnew' method='post' enctype='multipart/form-data'>
		<input type=text name="name" value="1252156"/>
		<!-- <input type=text name="subtitle" value="1111"/>
		<input type=text name="number" value="1233211234567"/> -->
		<input type=text name="shipDate" value="2018-01-25 20:14:35"/>
		<input type=text name="saleTime" value="2018-01-25 16:59:09"/>
		<input type=text name="presale" value="0"/>
		<input type=text name="protype" value="0"/>
		<input type=text name="groupId" value="19d8a3223452454298480aba4f652b23"/>
		<!-- <input type=text name="saleWay" value=""/>
		<input type=text name="refunds" value=""/>
		<input type=text name="shipcond" value=""/>
		<input type=text name="limitBuy" value=""/>
		<input type=text name="limitQty" value=""/>
		<input type=text name="delayDays" value=""/> -->
		<input type=text name="categoryId" value="148b51d1640043a99ca6a3a27af6a1bf"/>
		<!-- <input type=text name="unifyShip" value=""/>
		<input type=text name="shipTempId" value=""/>
		<input type=text name="stockQty" value=""/>
		<input type=text name="saledQty" value=""/>
		<input type=text name="shipCost" value=""/>
		<input type=text name="discount" value=""/>
		<input type=text name="limitedUser" value=""/> -->
		<input type=text name="displayStock" value="1"/>
		<!-- <input type=text name="salePrice" value=""/>
		<input type=text name="origPrice" value=""/>
		<input type=text name="costPrice" value=""/>
		<input type=text name="specification" value=""/> -->
		<input type=text name="distribution" value="0"/>
		<!-- <input type=text name="distPrice" value=""/>
		<input type=text name="validDate" value=""/>
		<input type=text name="eleVoucher" value=""/>
		<input type=text name="bespeak" value=""/>
		<input type=text name="holiday" value=""/>
		<input type=text name="serviceTel" value=""/>
		<input type=text name="delayHours" value=""/>
		<input type=text name="endValidDate" value=""/>
		<input type=text name="startValidDate" value=""/>
		<input type=text name="endBespeakTime" value=""/>
		<input type=text name="startBespeakTime" value=""/>
		<input type=text name="bespeakExplain" value=""/> -->
